    ...
    public void setUp() {
        try {
            if (tcpEndpoint == null) {
                ...
                method1 = RpcProxyFactory.INSTANCE.getMethodStub(tcpEndpoint, "FutureService", "method1");
                exceptionMethod = RpcProxyFactory.INSTANCE.getMethodStub(tcpEndpoint, "FutureService", "exceptionMethod");
                timeOutMethod = RpcProxyFactory.INSTANCE.getMethodStub(tcpEndpoint, "FutureService", "timeOutMethod");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
